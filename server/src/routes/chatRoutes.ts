...
// ============================================
// CREATE OR GET 1-TO-1 CONVERSATION  (protected)
// ============================================

router.post("/conversations", requireAuth, async (req, res) => {
  try {
    const currentUserId = req.user!.userId; // always from JWT
    const targetUserId = Number(req.body.otherUserId);
...
// ============================================
// GET MESSAGES  (protected, members only)
// ============================================
