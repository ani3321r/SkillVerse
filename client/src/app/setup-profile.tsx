...
/* ---------------------------------------------------------
   FONT + COLOR TOKENS (same system as the rest of the app)
--------------------------------------------------------- */
const FONT = {
...
function LogoMark({ size = 30 }: { size?: number }) {
  return (
    <Svg width={size} height={size * 1.1} viewBox="0 0 40 44" fill="none">
      ...
      <Path
        d="M15 15c0-1.6 1.6-2.8 5-2.8s5 1.1 5 2.6-1.6 2-4 2.2c-2.7.2-6 .6-6 3s2.7 3.6 6 3.6 5-1.2 5-2.8"
        stroke="#FFFFFF"
        strokeWidth={2}
        strokeLinecap="round"
        fill="none"
...
function IconHelp({ size = 16, color = COLORS.slate }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path
        d="M9.5 9.5a2.5 2.5 0 1 1 3.5 2.3c-.7.35-1 .8-1 1.7"
        stroke={color}
        strokeWidth={1.8}
        strokeLinecap="round"
      />
...
function IconLinkedin({ size = 18 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      ...
      <Path
        d="M11.5 10.3h2.3v1.1c.4-.7 1.2-1.3 2.4-1.3 2 0 3.1 1.3 3.1 3.8v4.1h-2.4v-3.7c0-1.1-.4-1.9-1.4-1.9-.8 0-1.3.6-1.5 1.1-.1.2-.1.5-.1.7v3.8h-2.4v-7.7z"
        fill="#FFFFFF"
      />
    </Svg>
  );
...
function IconTrophy({ size = 20, color = COLORS.iconGreen }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M8 4h8v5a4 4 0 0 1-8 0V4z" fill={color} stroke={color} strokeWidth={1.4} strokeLinejoin="round" />
      <Path d="M8 5H5a1 1 0 0 0-1 1v1a4 4 0 0 0 4 4" stroke={color} strokeWidth={1.5} strokeLinecap="round" />
      <Path d="M16 5h3a1 1 0 0 1 1 1v1a4 4 0 0 1-4 4" stroke={color} strokeWidth={1.5} strokeLinecap="round" />
      <Path d="M12 13v4" stroke={color} strokeWidth={1.5} strokeLinecap="round" />
      <Path d="M8.5 21h7l-1-4h-5l-1 4z" fill={color} stroke={color} strokeWidth={1.3} strokeLinejoin="round" />
    </Svg>
  );
}

function IconCode({ size = 18, color = COLORS.iconPurple }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
    ...
    try {
      ...
      const response = await fetch(
        `${API_URL}/api/users/profile`,
        {
          ...
          body: JSON.stringify({
            googleId:
              (params.googleId as string) || null,
            ...
            avatarUrl:
              (params.avatarUrl as string) || null,
          }),
        }
      );
      ...
      Alert.alert(
        "Profile Complete 🎉",
        "Your SkillVerse profile has been created.",
        [
          {
            text: "Continue",
            onPress: () => {
              router.replace(
                `/dashboard?userId=${data.user.id}`
              );
            },
          },
        ]
        ...
        >
          ...
          {isDesktop && (
            <View style={styles.leftCol}>
              <View style={styles.decorBlob}>
                <View style={[styles.floatingChip, styles.chipCap]}>
                  <IconGradCap size={16} color="#FFFFFF" />
                </View>
                ...
                <View style={[styles.floatingChip, styles.chipCode]}>
                  <IconCode size={16} color={COLORS.iconPurple} />
                </View>

                <View style={[styles.floatingChip, styles.chipTrophy]}>
                  <IconTrophy size={16} color={COLORS.iconGreen} />
                </View>
              </View>
              ...
              <Text style={styles.journeyText}>
                ...
                recommendations, projects, and opportunities.
              </Text>
          ...
          <View style={[styles.card, isDesktop && styles.cardDesktop]}>
            <View style={styles.cardHeader}>
              ...
              <View style={styles.cardHeaderText}>
                ...
                <Text style={styles.subtitle}>
                  Tell us about yourself so SkillVerse can personalize
            ...
            <Text style={styles.label}>
              Primary Interest <Text style={styles.required}>*</Text>
            </Text>

            <View style={styles.interestRow}>
              <InterestOption
                label="Software"
                selected={interest === "software"}
                onPress={() => setInterest("software")}
                iconBg={COLORS.iconBlueBg}
                icon={<IconLaptop size={15} color={COLORS.primary} />}
              />

              <InterestOption
                label="Hardware"
                selected={interest === "hardware"}
                onPress={() => setInterest("hardware")}
                iconBg={COLORS.iconGreenBg}
                icon={<IconChip size={15} color={COLORS.iconGreen} />}
              />

              <InterestOption
                label="Both"
                selected={interest === "both"}
                onPress={() => setInterest("both")}
                iconBg={COLORS.iconPurpleBg}
                icon={<IconLayers size={15} color={COLORS.iconPurple} />}
              />
            </View>
...
function InterestOption({
  ...
  return (
    <Pressable
      style={[styles.interestButton, selected && styles.interestSelected]}
      onPress={onPress}
    >
      ...
      <View style={[styles.interestIcon, { backgroundColor: iconBg }]}>
        {icon}
      </View>
