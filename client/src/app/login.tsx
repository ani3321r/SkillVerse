...
import Svg, { Path, Rect, Polyline, Circle, Text as SvgText } from "react-native-svg";
import {
  useFonts,
...
function GoogleG({ size = 20 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 18 18" fill="none">
      ...
      <Path
        fill="#34A853"
        d="M9 18c2.43 0 4.4673-.8064 5.9564-2.1818l-2.9087-2.2581c-.8064.54-1.8368.8618-3.0477.8618-2.3436 0-4.3282-1.5818-5.0359-3.7104H.9573v2.3318C2.4382 15.9832 5.4818 18 9 18z"
      />
      <Path
        fill="#FBBC05"
        d="M3.9641 10.71c-.18-.54-.2823-1.1159-.2823-1.71s.1023-1.17.2823-1.71V4.9582H.9573C.3477 6.1732 0 7.5477 0 9s.3477 2.8268.9573 4.0418L3.9641 10.71z"
      />
      <Path
        fill="#EA4335"
        d="M9 3.5782c1.3214 0 2.5077.4541 3.4405 1.3459l2.5818-2.5818C13.4632.8918 11.4259 0 9 0 5.4818 0 2.4382 2.0168.9573 4.9582L3.9641 7.29C4.6718 5.1614 6.6564 3.5782 9 3.5782z"
      />
    </Svg>
  );
}
...
export default function LoginScreen() {
  ...
  const handleGoogleLogin = async (
    ...
    try {
      ...
      if (!googleUser.id || !googleUser.email) {
        throw new Error(
          "Could not get Google account information"
        );
      }

      // ----------------------------------------
      // SEND USER TO OUR BACKEND
      // ----------------------------------------
  ...
  // ==========================================
  // EMAIL / SIGN UP (visual only — no screens wired up yet)
  // ==========================================

  const handleEmailPress = () => {
    Alert.alert(
      "Coming soon",
      "Email sign-in isn't set up yet — use Google for now."
    );
  };
  ...
  const handleSignUpPress = () => {
    Alert.alert(
      "Coming soon",
      "Sign up isn't set up yet — use Google to get started."
    );
  };
      ...
      {isDesktop && (
        <View style={styles.leftPanel}>
          ...
          <View style={styles.featureList}>
            <FeatureRow
              icon={<IconUsers size={22} color={COLORS.primary} />}
              iconBg={COLORS.iconBlueBg}
              title="Collaborate"
              description="Work with passionate developers and designers."
            />
            <FeatureRow
              icon={<IconCode size={22} color={COLORS.iconGreen} />}
              iconBg={COLORS.iconGreenBg}
              title="Innovate"
              description="Solve real-world problems and build impactful solutions."
            />
            <FeatureRow
              icon={<IconTrophy size={22} color={COLORS.iconPurple} />}
              iconBg={COLORS.iconPurpleBg}
              title="Win Prizes"
              description="Compete, showcase your ideas and win exciting rewards."
            />
          </View>
